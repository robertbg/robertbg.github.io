...
function fetchAllItems(searchStr) {
  const endpoints = [
    `https://swapi.dev/api/people/?search=${searchStr}`,
    `https://swapi.dev/api/films/?search=${searchStr}`,
    `https://swapi.dev/api/starships/?search=${searchStr}`,
    `https://swapi.dev/api/species/?search=${searchStr}`,
    `https://swapi.dev/api/planets/?search=${searchStr}`,
  ]
